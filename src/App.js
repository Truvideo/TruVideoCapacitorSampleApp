...
//               const url = parsedResponse.remoteUrl ?? parsedResponse.uploadedFileURL;
...
//               //     const response = uploadMediaResponse.response || {};
//               //     const remoteUrl = response.remoteUrl;
//               //     const uploadedFileURL = response.uploadedFileURL;

//               //     const url = remoteUrl || uploadedFileURL; // prefer remoteUrl first

//               //     console.log("✅ Upload Completed. URL:", url);

              
//               // console.log("uploadMedia Responnse " , uploadMediaResponse.response ); 
//               // const url =  uploadMediaResponse.response.remoteUrl ?? uploadMediaResponse.response.uploadedFileURL ; 
//               // console.log("URLs " , uploadMediaResponse.response.remoteUrl )
//               // if(url) 
//               //   setUploadedImages((prevImages) => [...prevImages, url]);
...
//   }
  ...
  //     <IonRouterOutlet>
  //       <Route exact path="/" component={HomeComponent} />
  //       <Route exact path="/trim" component={HomeComponent} />
  //       <Route exact path="/compare" component={HomeComponent} />
